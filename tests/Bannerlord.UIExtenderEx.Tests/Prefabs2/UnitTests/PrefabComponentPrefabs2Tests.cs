...
");
		...
		public void RegisterPatch_XmlDocument_InsertAsFirstChild()
		{
			...
			var patch = PatchCreator.ConstructInsertPatch(InsertType.Child, patchedDocument, 0);
		...
		public void RegisterPatch_XmlNodes_InsertMultipleChildren()
		{
			...
			var patch = PatchCreator.ConstructInsertPatch(InsertType.Child, patchedDocument!.DocumentElement!.ChildNodes.Cast<XmlNode>(), 0);
		...
		public void RegisterPatch_XmlNodes_PassXmlDocumentsAsXmlNodes()
		{
			...
			var patch = PatchCreator.ConstructInsertPatch(InsertType.Child, new List<XmlNode> { patchedDocument1, patchedDocument2, patchedDocument3 }, 0);
